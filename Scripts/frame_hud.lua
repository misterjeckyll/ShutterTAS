...
function()
    ...
    log("----------------------------------------")
    log("TAS DEBUG")
    log("Frame      = " .. tostring(TAS.Frame))
    log("GameTime   = " .. tostring(TAS.GameTime))
    log("Visible    = " .. tostring(TAS.Visible))
    log("HUD        = " .. tostring(TAS.HUD))
    log("Panel      = " .. tostring(TAS.Panel))
    log("TextFrame  = " .. tostring(TAS.TextFrame))
    log("TextTime   = " .. tostring(TAS.TextTime))
    log("TextInput  = " .. tostring(TAS.TextInput))
    log("TextEvent  = " .. tostring(TAS.TextEvent))
    log("InitHandle = " .. tostring(TAS.InitHandle))
    log("TickHandle = " .. tostring(TAS.TickHandle))
    log("----------------------------------------")
end
...
log("Compact TAS HUD")
log("EngineTickAvailable = " .. tostring(EngineTickAvailable))
log("F7 = Toggle HUD")
log("F8 = Debug")
